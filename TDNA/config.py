...
class chemprotProcessor(generalProcessor):
    def get_labels(self):
        return ['INDIRECT-UPREGULATOR', 'UPREGULATOR', 'INHIBITOR', 'DOWNREGULATOR', 'SUBSTRATE', 'ACTIVATOR', 'AGONIST-ACTIVATOR',
     'PRODUCT-OF', 'AGONIST-INHIBITOR', 'INDIRECT-DOWNREGULATOR', 'SUBSTRATE_PRODUCT-OF', 'ANTAGONIST', 'AGONIST']
